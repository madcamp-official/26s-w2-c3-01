...
앱을 debug로 실행한 뒤 Android Studio의 `View → Tool Windows → App Inspection → Database Inspector`에서 `melody_alias_candidates`를 확인합니다. 좌표·JWT·주변 사용자 목록은 Room에 저장하지 않습니다.
