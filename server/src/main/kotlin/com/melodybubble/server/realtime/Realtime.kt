...
object RealtimeEventTypes {
    const val LOUNGE_CREATED = "LOUNGE_CREATED"
    const val LOUNGE_RADIUS_CHANGED = "LOUNGE_RADIUS_CHANGED"
    const val LOUNGE_USER_COUNT_CHANGED = "LOUNGE_USER_COUNT_CHANGED"
    const val USER_ENTERED_LOUNGE = "USER_ENTERED_LOUNGE"
    const val USER_LEFT_LOUNGE = "USER_LEFT_LOUNGE"
    const val LOUNGE_MERGED = "LOUNGE_MERGED"
    const val LOUNGE_DELETED = "LOUNGE_DELETED"
    const val CHAT_ROOM_MOVED = "CHAT_ROOM_MOVED"
    const val CHAT_ROOM_DELETED = "CHAT_ROOM_DELETED"
    ...
    const val CHAT_ROOM_MEMBER_JOINED = "CHAT_ROOM_MEMBER_JOINED"
    const val CHAT_ROOM_MEMBER_LEFT = "CHAT_ROOM_MEMBER_LEFT"
    ...
    const val SUB_LOUNGE_DELETED = "SUB_LOUNGE_DELETED"
    ...
    const val RECOMMENDATION_CARD_DELETED = "RECOMMENDATION_CARD_DELETED"
