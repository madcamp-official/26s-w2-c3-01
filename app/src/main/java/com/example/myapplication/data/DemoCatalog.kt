    ...
    fun initialState(isOnboardingComplete: Boolean): MelodyUiState {
        val nearby = listOf(
            NearbyListener(
                ...
                displayPosition = abstractDisplayPosition("nearby-mint-session", Proximity.WITHIN_10M),
                matchScore = 93,
            ...
            NearbyListener(
                ...
                displayPosition = abstractDisplayPosition("nearby-nova-session", Proximity.WITHIN_20M),
                matchScore = 70,
